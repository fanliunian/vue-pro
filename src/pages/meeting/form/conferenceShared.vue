   ...
   <div class="main_information">
      ...
      <div class="form_main border_radius">
         <div class="form_table_title pb-16 flex_layout">
            <div class="table_title">共享会议库</div>
         </div>
         <div class="form_table">
            <el-table :data="tableData" stripe style="width: 100%;height: 100%">
               ...
               <el-table-column label="更新时间" prop="createTime" :formatter="arrivaltime" sortable>
                  <template slot="header" slot-scope="scope">
                     <el-tooltip class="item" effect="dark" content="点击排序" placement="top">
                        <span>更新时间</span>
                     </el-tooltip>
...
<script>
   ...
   import {getConferenceSharedData} from '@/api/meeting'
   ...
   export default {
      ...
      methods: {
         ...
         getData() {
            ...
            getConferenceSharedData(data).then(res => {
         ...
         //链接跳转
         detail(row) {
            let url = process.env.VUE_APP_MEET + '/form/formBus/hyxq/get?id=' + row.id + '&canExport=true&parentGridId=grid&keyId=' + row.id
