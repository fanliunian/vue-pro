   ...
   <div class="main_information">
      ...
      <div class="form_main border_radius">
         <div class="form_table_title pb-16 flex_layout flex_between">
            <div class="table_title">单位议题库</div>
            ...
            <el-table :data="tableData" stripe style="width: 100%;height: 100%"
               ...
               <el-table-column label="操作" min-width="100">
                  <template slot-scope="scope">
                     ...
                     <div class="form_operation">
                        <div title="共享" @click="shared(scope.row)">
...
<script>
   ...
   import {delectIssueData, getIssueUnitData} from '@/api/meeting'
   ...
   export default {
      ...
      methods: {
         ...
         getData() {
            ...
            getIssueUnitData(data).then(res => {
